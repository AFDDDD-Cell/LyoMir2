...
namespace GameSvr
{
    public partial class TPlayObject
    {
        ...
        internal bool ShouldDispatchNativeClientMessage(ClientPacket packet)
        {
            ...
            // 1018 is the CM_LOGINNOTICEOK ident that completes the client version
            // handshake. The native dispatcher admits it unconditionally and makes
            // the handshake state visible to subsequent packets. The handshake message
            // itself also needs to reach the switch so its payload is processed.
